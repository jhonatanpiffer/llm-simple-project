...
class IncidentOutput(BaseModel):
    ...
    """
    data_ocorrencia: Optional[str] = Field(None, description="Data e hora do incidente.")
    local: Optional[str] = Field(None, description="Local do incidente.")
    tipo_incidente: Optional[str] = Field(None, description="Tipo ou categoria do incidente.")
